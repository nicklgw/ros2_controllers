...
#include "biblade_drive_controller/biblade_drive_controller.hpp"
...
class TestableBibladeDriveController : public biblade_drive_controller::BibladeDriveController
{
public:
  using BibladeDriveController::BibladeDriveController;
...
class TestBibladeDriveController : public ::testing::Test
{
protected:
  ...
  void SetUp() override
  {
    controller_ = std::make_unique<TestableBibladeDriveController>();
  ...
  const std::string controller_name = "test_biblade_drive_controller";
  std::unique_ptr<TestableBibladeDriveController> controller_;
...
TEST_F(TestBibladeDriveController, init_fails_without_parameters)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::ERROR);
}

TEST_F(TestBibladeDriveController, init_fails_with_only_left_or_only_right_side_defined)
{
...
TEST_F(TestBibladeDriveController, configure_fails_with_mismatching_wheel_side_size)
{
  ASSERT_EQ(
...
TEST_F(TestBibladeDriveController, configure_succeeds_when_wheels_are_specified)
{
...
TEST_F(TestBibladeDriveController, configure_succeeds_tf_test_prefix_false_no_namespace)
{
...
TEST_F(TestBibladeDriveController, configure_succeeds_tf_test_prefix_true_no_namespace)
{
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
  std::string frame_prefix = "test_prefix";
...
TEST_F(TestBibladeDriveController, configure_succeeds_tf_blank_prefix_true_no_namespace)
{
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
...
TEST_F(TestBibladeDriveController, configure_succeeds_tf_test_prefix_false_set_namespace)
{
...
TEST_F(TestBibladeDriveController, configure_succeeds_tf_test_prefix_true_set_namespace)
{
  std::string test_namespace = "/test_namespace";
...
TEST_F(TestBibladeDriveController, configure_succeeds_tf_blank_prefix_true_set_namespace)
{
  std::string test_namespace = "/test_namespace";
  std::string odom_id = "odom";
  std::string base_link_id = "base_link";
...
TEST_F(TestBibladeDriveController, activate_fails_without_resources_assigned)
{
  ASSERT_EQ(InitController(), controller_interface::return_type::OK);
...
TEST_F(TestBibladeDriveController, activate_succeeds_with_pos_resources_assigned)
{
  ASSERT_EQ(InitController(), controller_interface::return_type::OK);
...
TEST_F(TestBibladeDriveController, activate_succeeds_with_vel_resources_assigned)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestBibladeDriveController, activate_fails_with_wrong_resources_assigned_1)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestBibladeDriveController, activate_fails_with_wrong_resources_assigned_2)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestBibladeDriveController, cleanup)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
...
TEST_F(TestBibladeDriveController, correct_initialization_using_parameters)
{
  ASSERT_EQ(
    InitController(
      left_wheel_names, right_wheel_names,
