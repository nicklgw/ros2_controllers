...
namespace biblade_drive_controller
{
...
BibladeDriveController::BibladeDriveController() : controller_interface::ControllerInterface() {}

const char * BibladeDriveController::feedback_type() const
{
  return params_.position_feedback ? HW_IF_POSITION : HW_IF_VELOCITY;
}

controller_interface::CallbackReturn BibladeDriveController::on_init()
{
  try
  {
...
InterfaceConfiguration BibladeDriveController::command_interface_configuration() const
{
...
InterfaceConfiguration BibladeDriveController::state_interface_configuration() const
{
  std::vector<std::string> conf_names;
  for (const auto & joint_name : params_.left_wheel_names)
  {
...
controller_interface::return_type BibladeDriveController::update(
...
controller_interface::CallbackReturn BibladeDriveController::on_configure(
...
controller_interface::CallbackReturn BibladeDriveController::on_activate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn BibladeDriveController::on_deactivate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn BibladeDriveController::on_cleanup(
  const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
...
controller_interface::CallbackReturn BibladeDriveController::on_error(const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
    return controller_interface::CallbackReturn::ERROR;
...
bool BibladeDriveController::reset()
{
...
void BibladeDriveController::halt()
{
...
controller_interface::CallbackReturn BibladeDriveController::configure_side(
...
CLASS_LOADER_REGISTER_CLASS(
  biblade_drive_controller::BibladeDriveController, controller_interface::ControllerInterface)
