...
static constexpr size_t STATE_STEER_AXIS = 4;
...
static constexpr size_t CMD_STEER_WHEEL = 4;

static constexpr size_t NR_STATE_ITFS = 5;
static constexpr size_t NR_CMD_ITFS = 5;
